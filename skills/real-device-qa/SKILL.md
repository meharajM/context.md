---
name: real-device-qa
description: Run deterministic, evidence-backed QA on a physical iOS device using WebDriverAgent. Use when validating app behavior, device-specific flows, or real-user journeys that cannot be proven in a simulator.
license: MIT
metadata:
  author: meharajM
  version: "0.0.1"
  repository: meharajM/context.md
---
