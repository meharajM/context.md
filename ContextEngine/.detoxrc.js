...
module.exports = {
  ...
  apps: {
    ...
    'ios.release': {
      type: 'ios.app',
      binaryPath: 'ios/build/Build/Products/Release-iphonesimulator/ContextEngine.app',
      build: 'xcodebuild -workspace ios/ContextEngine.xcworkspace -scheme ContextEngine -configuration Release -sdk iphonesimulator -derivedDataPath ios/build'
    },
    'android.debug': {
      type: 'android.apk',
